...
void execute_one(void)
{
  ...
  *(uint64_t*)0x20000260 = 0;
  ...
  STORE_BY_BITMASK(uint64_t, , 0x20000268, 1, 9, 1);
  ...
  STORE_BY_BITMASK(uint64_t, , 0x20000268, 1, 17, 1);
  ...
  STORE_BY_BITMASK(uint64_t, , 0x20000268, 1, 26, 1);
  STORE_BY_BITMASK(uint64_t, , 0x20000268, 0, 27, 1);
  STORE_BY_BITMASK(uint64_t, , 0x20000268, 1, 28, 1);
  STORE_BY_BITMASK(uint64_t, , 0x20000268, 1, 29, 1);
  ...
  STORE_BY_BITMASK(uint64_t, , 0x20000268, 1, 36, 1);
  STORE_BY_BITMASK(uint64_t, , 0x20000268, 1, 37, 1);
  ...
  *(uint64_t*)0x200002b8 = -1;
  syscall(__NR_perf_event_open, /*attr=*/0x20000240ul, /*pid=*/0, /*cpu=*/-1,
          /*group=*/-1, /*flags=*/8ul);
}
int main(void)
{

...
void loop(void)
{
  ...
  NONFAILING(*(uint8_t*)0x20000009 = 0xeb);
  NONFAILING(*(uint8_t*)0x2000000a = 0x67);
  NONFAILING(*(uint8_t*)0x2000000b = 8);
  ...
  NONFAILING(*(uint64_t*)0x20000038 = 0x74);
  NONFAILING(*(uint64_t*)0x20000040 = 2);
  NONFAILING(*(uint64_t*)0x20000048 = 0x109ea);
  NONFAILING(*(uint64_t*)0x20000050 = 6);
  NONFAILING(*(uint32_t*)0x20000058 = 0);
  NONFAILING(*(uint32_t*)0x2000005c = 9);
  NONFAILING(*(uint64_t*)0x20000060 = 0x10);
  NONFAILING(*(uint32_t*)0x20000068 = 0x7d);
  NONFAILING(*(uint16_t*)0x2000006c = 0x40);
  NONFAILING(*(uint16_t*)0x2000006e = 0);
  NONFAILING(*(uint32_t*)0x20000070 = 0);
  NONFAILING(*(uint32_t*)0x20000074 = 0x2000);
  NONFAILING(*(uint64_t*)0x20000078 = 3);
  syscall(__NR_perf_event_open, /*attr=*/0x20000000ul, /*pid=*/0,
          /*cpu=*/0x400000001ul, /*group=*/-1,

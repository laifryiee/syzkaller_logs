...
void loop(void)
{
  ...
  if (res != -1)
    r[0] = res;
  //  ioctl$SNAPSHOT_SET_SWAP_AREA arguments: [
  //    fd: fd_snapshot (resource)
  //    cmd: const = 0x400c330d (4 bytes)
  //    arg: ptr[in, resume_swap_area] {
  //      resume_swap_area {
  //        offset: int64 = 0xb8000 (8 bytes)
  //        dev: int32 = 0x800 (4 bytes)
  //      }
  //    }
  //  ]
  *(uint64_t*)0x200000000040 = 0xb8000;
  *(uint32_t*)0x200000000048 = 0x800;
  syscall(__NR_ioctl, /*fd=*/r[0], /*cmd=*/0x400c330d,
          /*arg=*/0x200000000040ul);
  //  ioctl$SNAPSHOT_AVAIL_SWAP_SIZE arguments: [
  //    fd: fd_snapshot (resource)
  //    cmd: const = 0x80083314 (4 bytes)
  //    arg: nil
  //  ]
  syscall(__NR_ioctl, /*fd=*/r[0], /*cmd=*/0x80083314, /*arg=*/0ul);
  //  ioctl$SNAPSHOT_ALLOC_SWAP_PAGE arguments: [
  //    fd: fd_snapshot (resource)
  //    cmd: const = 0x80083314 (4 bytes)
  //    arg: nil
  //  ]

...
void execute_one(void)
{
  ...
  *(uint32_t*)0x2000000c = 0x200;
  *(uint32_t*)0x20000010 = 0x17a;
  *(uint32_t*)0x20000018 = -1;
  memset((void*)0x2000001c, 0, 12);
  syz_io_uring_setup(/*entries=*/0x482c, /*params=*/0x20000000, /*ring_ptr=*/0,
                     /*sqes_ptr=*/0);
  ...
  if (res != -1)
    r[0] = res;
  syscall(__NR_fallocate, /*fd=*/r[0], /*mode=*/0ul, /*off=*/7ul,
          /*len=*/0xf000000ul);
}
int main(void)
{

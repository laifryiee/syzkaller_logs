...
void execute_one(void)
{
  ...
  *(uint32_t*)0x20000018 = -1;
  ...
  res =
      syscall(__NR_io_uring_setup, /*entries=*/0x1c76, /*params=*/0x20000000ul);
  if (res != -1)
    r[0] = res;
